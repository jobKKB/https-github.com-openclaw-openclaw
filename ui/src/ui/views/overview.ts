...
export function renderOverview(props: OverviewProps) {
    ...
    return html`
      <div class="muted" style="margin-top: 8px">
        ...
        <div style="margin-top: 6px">
          <span class="mono">zhoudai devices list</span><br />
          <span class="mono">zhoudai devices approve &lt;requestId&gt;</span>
        </div>
        ...
        <div style="margin-top: 6px">
          <a
            class="session-link"
            href="https://github.com/jobKKB/https-github.com-openclaw-openclaw"
            target="_blank"
            rel="noreferrer"
  ...
  const authHint = (() => {
    ...
    if (isAuthRequired) {
      return html`
        <div class="muted" style="margin-top: 8px">
          ...
          <div style="margin-top: 6px">
            <span class="mono">zhoudai dashboard --no-open</span> → tokenized URL<br />
            <span class="mono">zhoudai doctor --generate-gateway-token</span> → set token
          </div>
          <div style="margin-top: 6px">
            <a
              class="session-link"
    ...
    return html`
      <div class="muted" style="margin-top: 8px">
        ${t("overview.auth.failed", { command: "zhoudai dashboard --no-open" })}
        <div style="margin-top: 6px">
          <a
            class="session-link"
            href="https://github.com/jobKKB/https-github.com-openclaw-openclaw"
