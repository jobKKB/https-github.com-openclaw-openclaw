...
export const zh_CN: TranslationMap = {
  ...
  subtitles: {
    ...
    config: "安全地编辑 ~/.zhoudai/zhoudai.json。",
  ...
  overview: {
    ...
    auth: {
      required: "此网关需要身份验证。添加令牌或密码，然后点击「连接」。",
      failed: "身份验证失败。请使用 {command} 重新复制令牌化 URL，或更新令牌，然后点击「连接」。",
    },
    pairing: {
      hint: "此设备需要网关主机的配对批准。",
      mobileHint:
        "在手机上？从桌面运行 zhoudai dashboard --no-open 复制完整 URL（包括 #token=...）。",
    },
    insecure: {
